...
class Setup(SetupTemplate):
    ...
    def form_show(self, **event_args):
        ...
        with anvil.server.no_loading_indicator:
            ...
            self.tenant_secrets = self.tenant_secrets or anvil.server.call(
                "get_tenanted_data", Global.tenant_id, "tenant_secrets"
            )
    ...
    def edit_plan(self, item, **event_args):
        self.rp_paypal_plans.items = [
            i for i in self.rp_paypal_plans.items if i["id"] != item["id"]
        ] + [item]
